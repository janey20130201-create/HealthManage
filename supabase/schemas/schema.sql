-- Declarative target schema for the caring project.
-- Edit this file for future schema changes, then generate/review a new migration.
-- Do not run this file after the initial migration on the same database.
